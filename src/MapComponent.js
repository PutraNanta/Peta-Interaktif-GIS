        ...
        >
          ...
          >
            <div>
              ...
              >
                {isAdminMode ? "Peta Interaktif" : "Peta Interaktif"}
              </h3>
              <p
                style={{
                  margin: "6px 0 0 0",
          ...
          <div style={{ flex: 1, overflowY: "auto" }}>
            ...
            {isAdminMode && (
              <div style={{ borderBottom: "1px solid #f1f3f5" }}>
                <button
                  onClick={() =>
                    setAccordion(accordion === "login" ? "" : "login")
                  }
                  style={{
                    width: "100%",
                    padding: "22px 30px",
            ...
            <div style={{ borderBottom: "1px solid #f1f3f5" }}>
              <button
                onClick={() =>
                  setAccordion(accordion === "filter" ? "" : "filter")
                }
                style={{
                  width: "100%",
                  padding: "22px 30px",
                  ...
                  {masterTypes.map((t) => (
                    <div key={t.nama_tipe} style={{ marginBottom: "15px" }}>
                      ...
                      >
                        <input
                          type="checkbox"
                          checked={filters[t.nama_tipe] || false}
                          onChange={() => handleFilterChange(t.nama_tipe)}
                          style={{
                            marginRight: "15px",
                            transform: "scale(1.3)",
                            accentColor: "#3498db",
